      ...
      <div className="header">
        ...
        <div className="flex">
          ...
          <div className='flex w-full mt-10'>
            ...
            <div className='flex justify-center gap-20 border-solid border-8 border-white rounded-3xl ml-20 py-4 w-4/5 min-w-max fadein-zoom text-center' style={{animationDelay:"8s"}}>
              <div className=''>
